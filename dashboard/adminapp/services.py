## services nimaga kerak boladi bizga----bu kotta proeyklarning db malumotlari ko'p bolsa tezda olib kelish uchun
## bu kodlarni yozib qoyishimiz kerak boladi
...
def get_student():
    with closing(connection.cursor()) as cursor:
        ...
        adminapp_group.name as groups, adminapp_student.image as image from adminapp_student left join
